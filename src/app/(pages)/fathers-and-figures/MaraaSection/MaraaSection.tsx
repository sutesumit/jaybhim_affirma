    ...
    <div className='flex text-container flex-col items-center justify-center gap-2'>
      ...
      <Gradient1>
        <div className='relative glass-hover isolate p-5 flex flex-col items-center justify-center'>
          ...
          <div className="glass-hover my-2 p-1 rounded-sm transition-all duration-300 ease-in-out">
          ...
          <div className='text-container glass-hover rounded-sm !text-xs !text-center p-1 my-5'>
