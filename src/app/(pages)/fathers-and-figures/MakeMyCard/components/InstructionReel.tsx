...
const InstructionReel = () => {
  ...
  return (
    <m.div
      className='phone-wrapper w-fit relative isolate h-full flex z-10 relative lg:absolute md:left-2 mx-auto md:-rotate-2'
      ref={phoneCaseRef}
    ...
    >
      <m.div
        ...
        className="relative mr-5 z-100 card-shadow cursor-grab col-span-1 flex-1 md:my-0 m-auto max-h-[80vh] aspect-[7/12] bg-black/85 rounded-2xl p-2 overflow-hidden shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)]"
      >
      ...
      <div className='absolute h-full right-0 py-5 flex items-center -z-10'>
        <m.div 
