    ...
    <>
        <div className='title-container relative pt-14 z-0 w-full m-auto'>
            ...
            <div className='font-title text-center pt-6'>{title}</div>
              <div className='description m-5 flex flex-col md:flex-row max-h-[60vh] hover:shadow-[inset_0px_0px_15px_-5px_rgba(59,_130,_246,_0.5)] p-5 gap-12 justify-between place-items-start border-[1px] border-dotted border-[--primary-blue] rounded-sm overflow-y-auto scrollbar-thin transition-all duration-300'>
