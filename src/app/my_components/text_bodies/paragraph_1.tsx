...
const Paragraph_1 = () => {
  return (
    <div className='text-container paragraph-container'>
      <p>I used to be an artist, and my art practices were always a medium to explore the political within the personal, driven by a clear intent to actively heal from caste-patriarchal traumas. My goal was to celebrate Dalit cultural capital with pride and intimacy through my photographs. Even before I fully understood the phrase “the personal is political,” I aspired for my art to serve as both fodder and fuel for political discourse.</p>
    </div>
  )
}
