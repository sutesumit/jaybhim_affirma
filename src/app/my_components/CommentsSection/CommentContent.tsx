  ...
  return (
    <>
      ...
      <span
        ...
        className="text-xs text-[--primary-blue] opacity-30 px-2 rounded-sm border border-[var(--primary-blue)] hover:bg-[--primary-blue] hover:text-[--primary-white] hover:opacity-100 transition-all duration-300"
      >
