...
const Footer: React.FC<FooterProps> = () => {
    ...
    return (
        <>
            ...
            <footer className='flex justify-between items-center m-2 px-4 py-2 rounded-sm text-[var(--primary-blue)] font-title text-xs cursor-pointer border-[1px] opacity-40 hover:opacity-100 hover:border-[var(--primary-blue)] transition-all duration-1000 ease-in-out'>
                <div className=''>You are reading this page for the last <span className=''>{formatTime(elapsedTime)}</span></div>
                <div className=''><span className=''>{getDaysUntilDalitHistoryMonth()}</span> days until Dalit History Month!</div>
