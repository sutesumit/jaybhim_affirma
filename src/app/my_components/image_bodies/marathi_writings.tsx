...
const MarathiWritings = () => {
  return (
    <div className='marathi-writings-container font-rajdhani text-[--primary-white] max-w-[100ch] mx-auto m-2 px-4 sm:px-6'>
      <div className="all-cards flex overflow-x-auto snap-x snap-mandatory w-full scrollbar-hide gap-4 py-[1px] scrollbar-thin scrollbar-thumb-[--primary-blue] scrollbar-track-transparent">
        {flashFictions.map((fiction, index) => (
          <div key={index} className="card bg-[--primary-blue] rounded-sm w-full flex-shrink-0 snap-center">
            <div className="flex flex-col-reverse md:flex-row sm:flex-row items-start gap-4 p-6">
              <div className="card-content md:w-[50%] sm:w-[50%] aspect-square overflow-y-auto scrollbar-thin scrollbar-thumb-[--primary-blue] scrollbar-track-transparent">
