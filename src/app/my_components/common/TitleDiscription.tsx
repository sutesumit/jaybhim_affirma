  ...
  return (
    <>
        <div className='title-container relative w-full p-4 sm:p-7 m-auto'>
            ...
            <div className='max-w-[90ch] md:m-auto bg-white/50 backdrop-blur-sm border-[1px] border-[--primary-blue] rounded-sm overflow-y-scroll'>
              <div className='font-title text-center pt-6'>{title}</div>
              <div className='description m-5 flex flex-col md:flex-row max-h-[60vh] p-5 gap-12 justify-between place-items-start border-[1px] border-dotted border-[--primary-blue] rounded-sm overflow-y-scroll scrollbar-thin'>
