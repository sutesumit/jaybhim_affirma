...
const Footer: React.FC = () => {
    ...
    return (
        <>
            ...
            <footer className='relative grid grid-cols-1 md:grid-cols-3 justify-between items-center m-2 px-4 h-10 overflow-hidden rounded-sm text-[var(--primary-blue)] font-rajdhani font-medium text-sm cursor-pointer card-bg card-shadow glass-hover'>
