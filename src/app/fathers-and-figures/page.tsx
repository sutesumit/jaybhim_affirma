  ...
  return (
    <>
      ...
      <div className='relative isolate p-5'>
        ...
        <div className='stories text-center flex text-container flex-row gap-2 !px-0 !py-4 !overflow-x-auto'>
          <div className='story-container w-full flex-shrink-0 p-3 text-xs border-[1px] border-[var(--primary-blue)] rounded-sm'>
