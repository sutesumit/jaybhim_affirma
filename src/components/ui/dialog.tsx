...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close className="absolute right-2 top-2 z-10 rounded-sm comment-tiny-button ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-[--primary-blue] focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground transition-all duration-300">
        <X className="h-3 w-3" />
