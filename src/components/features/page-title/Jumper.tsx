...
const Jumper = () => {
  ...
  return (
    <div className='m-auto items-center cursor-pointer relative'
      onClick={handleScroll}
    >
        <div
          className='flex relative gap-2 font-rajdhani items-center justify-center m-auto h-8 p-4 mb-4 w-fit overflow-clip card-bg button-style'
        >
