...
export function PageUnderConstruction({ 
  pageName,
  youtubeTimestamp = "",
  blogUrl = "https://lonerincovid.tumblr.com/"
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <p className="text-container !text-xs !text-center !leading-relaxed">
          But worry not, sumit is rolling up his sleeves,
          chasing down time and resources, and will bring this <span className='opacity-50'>{pageName}</span> page to life soon.<br />Hang tight!
        </p>
        ...
        <div className='text-container flex justify-center gap-2 font-title bg-blend-difference transition-colors duration-1000 ease-out'>
          <Link
            href={`https://youtu.be/llARFMPOTB0?t=${youtubeTimestamp}`}
            target="_blank"
